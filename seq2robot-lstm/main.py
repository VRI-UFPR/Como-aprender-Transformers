...
print(f"[Train]: Sentence: {sentence}, Translation: {translation}")

sentence = "Well move to Living_Sofa Grasp toy_duck then come back."
...
#test
sentence="Move to Living_Sofa get Japanese_Tea place it on Dining_Table okay."
...
print(f"[Test]: Sentence: {sentence}, Translation: {translation}")

sentence="Would you move to Sofa get white_cup bring it to Dining_Sofa."
...
print(f"[Test]: Sentence: {sentence}, Translation: {translation}")
#dev
sentence="Well get filled_plastic_bottle from Sofa go to Living_Room move to Side_Table."
...
print(f"[Dev]: Sentence: {sentence}, Translation: {translation}")
sentence="Can you bring rubik's_cube from Sofa go to lobby move to Living_Table."
translation = model_utils.translate_sentence(
     sentence,
     model,
     en_nlp,
